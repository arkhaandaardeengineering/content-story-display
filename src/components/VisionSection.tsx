  ...
  return (
    <section id="vision" className="py-24 bg-background">
      <div className="container mx-auto px-4" ref={ref}>
        ...
        >
          <span className="text-primary font-semibold text-sm uppercase tracking-wider block text-center mb-4">
            Our Vision
          </span>
          <h2 className="text-3xl md:text-5xl font-display font-bold text-foreground text-center mb-8">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed text-center mt-6">
